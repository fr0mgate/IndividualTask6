...
BankCard::BankCard(String holderSurname, String holderName,
                   String number, String validityPeriodMonth,
...
[[nodiscard]] String BankCard::getHolderSurname() const
{
...
[[nodiscard]] String BankCard::getNumber() const
{
    return number_;
}
...
void BankCard::setValidityPeriodMonth(const String& validityPeriodMonth)
{
    validityPeriodMonth_ = validityPeriodMonth;
}

[[nodiscard]] String BankCard::getValidityPeriodMonth() const
{
...
[[nodiscard]] String BankCard::getValidityPeriodYear() const
{
